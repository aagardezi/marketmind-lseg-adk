...
JSON_DATA=$(cat <<EOF
{
    "displayName": "MarketMind LSEG Agent_v2",
    "description": "Allows analysis of financial markets using LSEG Tick History data",
    "adk_agent_definition": 
    {
        "tool_settings": {
            "tool_description": "Various Market analysis tools including lseg tick history and finhub"
        },
        "provisioned_reasoning_engine": {
            "reasoning_engine":"projects/884152252139/locations/us-central1/reasoningEngines/5466969725395271680"
        }
    }
}
EOF
